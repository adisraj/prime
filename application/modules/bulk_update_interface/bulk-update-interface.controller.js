(() => {
  ...
  angular.module("rc.prime.bulkupdateinterface")
    .controller("bulkupdateinterfaceController", bulkupdateinterfaceController);
    bulkupdateinterfaceController.$inject = [
    "$scope",
    "$stateParams",
    "common",
    "CodeService",
  ...
  function bulkupdateinterfaceController(
    $scope,
    $stateParams,
    common,
    CodeService,
    ...
    let logger = common.Logger.getInstance("bulkupdateinterfaceController");
